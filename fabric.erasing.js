...
(function () {
  ...
  let __drawClipPath = fabric.Object.prototype._drawClipPath;
  let _needsItsOwnCache = fabric.Object.prototype.needsItsOwnCache;
  let _toObject = fabric.Object.prototype.toObject;
  let _getSvgCommons = fabric.Object.prototype.getSvgCommons;
  let __createBaseClipPathSVGMarkup =
    fabric.Object.prototype._createBaseClipPathSVGMarkup;
  let __createBaseSVGMarkup = fabric.Object.prototype._createBaseSVGMarkup;
  ...
  let __restoreObjectsState = fabric.Group.prototype._restoreObjectsState;
      ...
      if (eraser) {
        ...
        eraser.clone(function (eraser) {
          ...
          eraser.getObjects("path").forEach(function (path) {
            ...
            let originalTransform = fabric.util.multiplyTransformMatrices(
              transform,
  ...
  fabric.Eraser.fromObject = function (object, callback) {
    ...
    fabric.util.enlivenObjects(objects, function (enlivenedObjects) {
      ...
      fabric.util.enlivenObjectEnlivables(object, options, function () {
        callback &&
          callback(new fabric.Eraser(enlivenedObjects, options, true));
      });
    });
  };

  let __renderOverlay = fabric.Canvas.prototype._renderOverlay;
  /**
   * @fires erasing:start
   * @fires erasing:end
   */
  ...
  fabric.EraserBrush = fabric.util.createClass(
    ...
    /** @lends fabric.EraserBrush.prototype */ {
      ...
      applyClipPathToPath: function (
        ...
        let pathInvTransform = fabric.util.invertTransform(
          path.calcTransformMatrix()
        );
        let clipPathTransform = clipPath.calcTransformMatrix();
        let transform = clipPath.absolutePositioned
          ? pathInvTransform
